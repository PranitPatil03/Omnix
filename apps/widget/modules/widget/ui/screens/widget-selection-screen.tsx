        ...
        <div className="flex flex-col justify-between gap-y-2 px-2 py-6 font-semibold">
          <p className="text-3xl">
            {widgetSettings?.companyName
              ? `Hi! Welcome to ${widgetSettings.companyName} 👋`
              : "Hi! 👋"}
          </p>
          <p className="text-lg">
      ...
      <div className="flex flex-1 flex-col gap-y-4 p-4 overflow-y-auto">
        ...
        >
          <div className="flex items-center gap-x-2">
            <img src="/images/icons/message.png" alt="Message" className="size-5" />
        ...
        {hasVapiSecrets && widgetSettings?.vapiSettings?.assistantId && (
          ...
          >
            <div className="flex items-center gap-x-2">
              <img src="/images/icons/mic.png" alt="Mic" className="size-5" />
        ...
        {hasVapiSecrets && widgetSettings?.vapiSettings?.phoneNumber && (
          ...
          >
            <div className="flex items-center gap-x-2">
              <img src="/images/icons/call.png" alt="Call" className="size-5" />
